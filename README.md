DreamFactory Angular2 Sample
====================================

This repo contains a sample app using dreamfactory components written in Angular2.
...
#How develop/run the project on your local machine 
